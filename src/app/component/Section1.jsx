    ...
    <section id='home' className='mt-8'>
        ...
        <div className='flex sm:flex-row flex-col mt-20 justify-between items-end '>
            <div className='lg:w-6/12 sm:w-8/12 md:w-7/12 sm:p-4 px-8 lg:px-16 '>
                <div className='font-inter text-sm md:text-base lg:text-lg'><i>"Mulai transformasi digital Anda untuk meningkatkan efektivitas dan efisiensi dalam bisnis yang Anda jalankan."</i></div>
                <div className='lg:p-20 sm:p-8 mt-4 mb-2 sm:mt-0 '>
